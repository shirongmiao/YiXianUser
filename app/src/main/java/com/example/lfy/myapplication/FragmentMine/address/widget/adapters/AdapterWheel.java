...
package com.example.lfy.myapplication.FragmentMine.address.widget.adapters;

import android.content.Context;

import com.example.lfy.myapplication.FragmentMine.address.widget.views.WheelAdapter;
