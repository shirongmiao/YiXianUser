...
public class MineBean {
    ...
    public String CustomerIntegral;//积分
    public String MyCoupon;//优惠券
    public String AccountState;//账户情况
...
//    }
    ...
    public void setPhoneNameber(String phoneNameber) {
