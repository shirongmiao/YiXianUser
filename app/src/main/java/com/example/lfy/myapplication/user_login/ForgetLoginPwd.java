 ...
 */
public class ForgetLoginPwd extends AppCompatActivity {
    ...
    public static ForgetLoginPwd instance = null;
    ...
    protected void onResume() {
        super.onResume();
        forget_all.setVisibility(View.VISIBLE);
    }

    @Override
    protected void onPause() {
        super.onPause();
        forget_all.setVisibility(View.INVISIBLE);
    }
    ...
    private void initView() {
        ...
        ok_but.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (va.equals(yan + "")) {
                    Intent intent = new Intent(ForgetLoginPwd.this, SetLoginPwd.class);
